...
def generate_requests(endpoint, num_servers, features, entity_rows, entity_keyspace, requests, output):
    vegeta_requests = []
    ...
    for idx in range(requests):
        ...
        vegeta_request = {
            "method": "POST",
            "url": f"{endpoint}-{idx%num_servers}:{6566}/get-online-features",
